 ...
 * @author andre
 */
public class ControleFor extends javax.swing.JFrame {

    /**
     * Creates new form ControleFor
     */
    public ControleFor() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnCont.setFont(new java.awt.Font("Tahoma", 1, 36)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ControleFor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ControleFor().setVisible(true);
            }
        });
    }
